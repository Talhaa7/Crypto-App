...
/**
 * Base [ListAdapter] to standardize and simplify initialization for this component.
 * adapter item layout must be use [ViewDataBinding]
 * Items will be used in this adapter should implement [ListAdapterItem]
 */
